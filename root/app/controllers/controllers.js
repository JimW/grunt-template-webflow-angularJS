...
// AngularJS makes this possible via the $emit, $broadcast and $on methods on the Scope object. 
// A controller can fire an event to perform some action and then receive a notification that the action completed.
    ...
    function init() {
        // $scope.Webflow = Webflow || [];
        // $scope.Webflow.push(readyFunction);
  ...
  // console.log(ix); 
    ...
    $scope.webflowEnv = function () {
        console.log("testWebflow = " + $scope.Webflow.env());
    };

    $scope.mouseOverThing = function () {
        console.log("mouseOverThing " ); 
        // $scope.Webflow.modules.namespace = "sdf";
        // console.log($scope.Webflow.modules);
    };
